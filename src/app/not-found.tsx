  ...
  return (
    <main className="grid min-h-screen place-items-center bg-[#f5f3ee] px-4 text-stone-950">
      <section className="max-w-md rounded-lg border border-stone-200 bg-white p-6">
        ...
        <p className="mt-2 text-sm text-stone-600">That page is not available for this mission workspace.</p>
        <Link href="/app/dashboard" className="mt-5 inline-flex rounded-md bg-emerald-700 px-4 py-2 text-sm font-bold text-white">
          Dashboard
        </Link>
      </section>
    </main>
